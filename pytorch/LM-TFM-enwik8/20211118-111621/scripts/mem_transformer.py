...
class MemTransformerLM(nn.Module):
    ...
    def _forward(self, dec_inp, mems=None):
        ...
        if self.num_mem_tokens not in (0, None):
            ...
            print(next(self.parameters()).device, self.mem_tokens.device, mem_tokens.device, word_emb.device)
    ...
    def forward(self, data, target, *mems):
        ...
        if not self.mem_tokens: self.mem_tokens = self.init_mem_tokens()
